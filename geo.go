...
func trans(ctx *cli.Context) {
	...
	fmt.Println("BD09toWGS84:")
	fmt.Println(BD09toWGS84(lng, lat))
	fmt.Println("GCJ02toBD09:")
	fmt.Println(GCJ02toBD09(lng, lat))
	fmt.Println("GCJ02toWGS84:")
	fmt.Println(GCJ02toWGS84(lng, lat))
	fmt.Println("WGS84toGCJ02:")
	fmt.Println(WGS84toGCJ02(lng, lat))
	fmt.Println("WGS84toBD09:")
	fmt.Println(WGS84toBD09(lng, lat))
